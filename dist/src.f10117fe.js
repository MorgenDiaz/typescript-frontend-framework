...
var Attributes = /*#__PURE__*/_createClass(function Attributes(data) {
  ...
  this.set = function (updated) {
    if (updated !== undefined && _typeof(_this.data) === "object") {
      _this.data = Object.assign(Object.assign({}, _this.data), updated);
      console.log("set to ", _this.data);
    }
  };
...
var Observable = /*#__PURE__*/function () {
  ...
  _createClass(Observable, [{
    ...
    value: function unregisterListener(listener) {
      this.listeners = this.listeners.filter(function (observer) {
...
var Model = /*#__PURE__*/function (_Observable_1$Observa) {
  _inherits(Model, _Observable_1$Observa);
  var _super = _createSuper(Model);
  function Model(sync, attributes) {
    var _this;
    _classCallCheck(this, Model);
    _this = _super.call(this);
    _this.sync = sync;
    _this.attributes = attributes;
    _this.get = _this.attributes.get;
    _this.getAll = _this.attributes.getAll;
    return _this;
  }
  _createClass(Model, [{
    key: "set",
...
exports.Model = Model;
},{"../Observable":"src/Observable.ts"}],"node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _context2.abrupt("return", axios_1.default.put("".concat(this.rootUrl, "/").concat(id), data));
            case 5:
              return _context2.abrupt("return", axios_1.default.post(this.rootUrl, data));
            case 6:
            case "end":
...
var axios_1 = __importDefault(require("axios"));
var Observable_1 = require("../Observable");
var Collection = /*#__PURE__*/function (_Observable_1$Observa) {
  _inherits(Collection, _Observable_1$Observa);
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 2:
                response = _context.sent;
                data = response.data;
                this.models = data.map(function (record) {
                  return _this2.deserialize(record);
                });
                this.notifyObservers();
              case 6:
              case "end":
...
},{"axios":"node_modules/axios/index.js","../Observable":"src/Observable.ts"}],"src/models/User.ts":[function(require,module,exports) {
"use strict";
...
var User = /*#__PURE__*/function (_Model_1$Model) {
  ...
  function User(data) {
    ...
    var sync = new ApiSync_1.ApiSync("http://localhost:3000/users");
    var attributes = new Attributes_1.Attributes(data);
    _this = _super.call(this, sync, attributes);
    _this.notifyObservers = function () {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var listener = _step.value;
          listener.handleUserDataChanged(_this.getAll());
        }
      } catch (err) {
        _iterator.e(err);
      } finally {
  ...
  _createClass(User, [{
    ...
    value: function buildUserCollection() {
      return new Collection_1.Collection("http://localhost:3000/users", function (jsonUser) {
...
exports.User = User;
},{"./Attributes":"src/models/Attributes.ts","./Model":"src/models/Model.ts","./ApiSync":"src/models/ApiSync.ts","./Collection":"src/models/Collection.ts"}],"src/views/UsersForm.ts":[function(require,module,exports) {
"use strict";
...
var UserForm = /*#__PURE__*/function () {
  function UserForm(parent, model) {
    ...
    this.bindModel = function () {
      ...
      var userObserver = {
        handleUserDataChanged: function handleUserDataChanged(data) {
          alert("quah chuh! ".concat(data.name));
          alert("should render!!1");
          render();
        }
      };
      _this.model.registerListener(userObserver);
    };
...
var UsersForm_1 = require("./views/UsersForm");
...
var collectionObserver = {
  onUpdate: function onUpdate() {
    ...
    if (root) {
      var userForm = new UsersForm_1.UserForm(root, users.models[0]);
      userForm.render();
    } else {
...
users.fetch();
},{"./models/User":"src/models/User.ts","./views/UsersForm":"src/views/UsersForm.ts"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
