...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"src/Observable.ts":[function(require,module,exports) {
"use strict";
...
},{"axios":"node_modules/axios/index.js","../Observable":"src/Observable.ts"}],"src/models/Attributes.ts":[function(require,module,exports) {
"use strict";
...
exports.Model = Model;
},{"../Observable":"src/Observable.ts"}],"src/models/ApiSync.ts":[function(require,module,exports) {
"use strict";
...
exports.User = User;
},{"./Attributes":"src/models/Attributes.ts","./Model":"src/models/Model.ts","./ApiSync":"src/models/ApiSync.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
var users = new Collection_1.Collection("http://localhost:3000/users", function (jsonUser) {
  return new User_1.User(jsonUser);
});
