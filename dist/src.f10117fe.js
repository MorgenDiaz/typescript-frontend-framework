...
var Observable = /** @class */function () {
  ...
  Observable.prototype.registerListener = function (listener) {
    if (!this.listeners.includes(listener)) {
      this.listeners.push(listener);
    }
  };
  Observable.prototype.unregisterListener = function (listener) {
...
var User = /*#__PURE__*/function (_Observable_1$Observa) {
  _inherits(User, _Observable_1$Observa);
  ...
  function User(data) {
    ...
    _this.data = data;
    _this.sync = new Sync_1.Sync("http://localhost:3000/users");
...
exports.User = User;
},{"../Observable":"src/Observable.ts","./Attributes":"src/models/Attributes.ts","./Sync":"src/models/Sync.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
